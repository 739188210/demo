...
public class DeeperHeartBeatHandler extends ChannelInboundHandlerAdapter {
    public static final Logger logger = LoggerFactory.getLogger(DeeperHeartBeatHandler.class);
